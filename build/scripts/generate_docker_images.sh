...
git clone -b "v${VPN_VERSION}" https://github.com/yieldmine/DNP_VPN
...
git clone -b "v${IPFS_VERSION}" https://github.com/yieldmine/DNP_IPFS
...
git clone -b "v${BIND_VERSION}" https://github.com/yieldmine/DNP_BIND
...
git clone -b "v${DAPPMANAGER_VERSION}" https://github.com/yieldmine/DNP_DAPPMANAGER
